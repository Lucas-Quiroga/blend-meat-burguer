...
export const FeaturesDiagonal = () => {
  ...
  return (
    <section className="bg-black items-center flex justify-end h-screen">
      <motion.div
        initial={{ opacity: 0 }}
        ...
        <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-1 lg:items-center lg:gap-x-16 mr-[12rem]">
            <div className="mx-auto max-w-lg sm:text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
              <span
                className="text-4xl sm:text-5xl font-bold text-white sm:mr-[10rem] sm:tracking-wide sm:text-center"
                style={{ margin: 0 }}
              >
                COMUNICATE CON <br /> NOSOTROS
              </span>

              <div className="text-white mt-[5rem] flex flex-col gap-8 font-semibold text-xl mr-[10rem]">
